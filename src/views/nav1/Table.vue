...
<el-button type="primary" @click="handleAdd" icon="edit" >新增</el-button>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="addr" label="电话号码"  sortable>
			</el-table-column>
			<el-table-column prop="age" label="微信"  sortable>
			</el-table-column>
  ...
  <el-button type="danger" icon="delete" size="small" @click="handleDel(scope.$index, scope.row)">删除</el-button>
		...
		<el-dialog title="编辑" v-model="editFormVisible" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
				...
				<el-form-item label="电话" prop="addr">
		...
		<el-dialog title="新增" v-model="addFormVisible" :close-on-click-modal="false">
			<el-form :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
				...
				<el-form-item label="生日">
					<el-date-picker  placeholder="选择日期" v-model="addForm.birth" ></el-date-picker>
				</el-form-item>
				<el-form-item label="电话" prop="addr">
					<el-input type="input" v-model="addForm.addr"></el-input>
				</el-form-item>

				<el-form-item label="微信">
					<el-input type="input" v-model="addForm.age"></el-input>
				</el-form-item>
			</el-form>
			<div slot="footer" class="dialog-footer">
          ...
          if (Number.isInteger(value)) {
			...
			return {
				...
				editFormRules: {
					...
					addr:[{
					      required:true
					      ,trigger:'blur',validator:checkaddr}
					      ]
				},
				//编辑界面数据
				editForm: {
